    ...
    RUN: while(true){
      switch(S620){
        ...
        case 1 : 
          ...
          int biggest633 = 0;
          if(ends[6]>=biggest633){
            biggest633=ends[6];
          }
          if(ends[7]>=biggest633){
            biggest633=ends[7];
          }
          if(ends[8]>=biggest633){
            biggest633=ends[8];
          }
          if(ends[9]>=biggest633){
            biggest633=ends[9];
          }
          if(ends[10]>=biggest633){
            biggest633=ends[10];
          }
          if(biggest633 == 1){
            active[5]=1;
        ...
        case 2 : 
          ...
          int biggest639 = 0;
          if(ends[6]>=biggest639){
            biggest639=ends[6];
          }
          if(ends[7]>=biggest639){
            biggest639=ends[7];
          }
          if(ends[8]>=biggest639){
            biggest639=ends[8];
          }
          if(ends[9]>=biggest639){
            biggest639=ends[9];
          }

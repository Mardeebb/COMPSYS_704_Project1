    ...
    RUN: while(true){
      switch(S2128){
        ...
        case 1 : 
          ...
          int biggest2135 = 0;
          if(ends[2]>=biggest2135){
            biggest2135=ends[2];
          }
          if(ends[3]>=biggest2135){
            biggest2135=ends[3];
          }
          if(ends[4]>=biggest2135){
            biggest2135=ends[4];
          }
          if(ends[5]>=biggest2135){
            biggest2135=ends[5];
          }
          if(ends[6]>=biggest2135){
            biggest2135=ends[6];
          }
          if(biggest2135 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest2141 = 0;
          if(ends[2]>=biggest2141){
            biggest2141=ends[2];
          }
          if(ends[3]>=biggest2141){
            biggest2141=ends[3];
          }
          if(ends[4]>=biggest2141){
            biggest2141=ends[4];
          }
          if(ends[5]>=biggest2141){
            biggest2141=ends[5];
          }
          if(ends[6]>=biggest2141){
            biggest2141=ends[6];
          }
          if(biggest2141 == 1){
            active[1]=1;

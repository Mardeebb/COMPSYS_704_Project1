    ...
    RUN: while(true){
      switch(S2844){
        ...
        case 1 : 
          ...
          int biggest2851 = 0;
          if(ends[2]>=biggest2851){
            biggest2851=ends[2];
          }
          if(ends[3]>=biggest2851){
            biggest2851=ends[3];
          }
        ...
        case 2 : 
          ...
          int biggest2857 = 0;
          if(ends[2]>=biggest2857){
            biggest2857=ends[2];
          }
          if(ends[3]>=biggest2857){
            biggest2857=ends[3];
          }
          if(ends[4]>=biggest2857){
            biggest2857=ends[4];
          }
          if(ends[5]>=biggest2857){
            biggest2857=ends[5];
          }
          if(ends[6]>=biggest2857){
            biggest2857=ends[6];
          }
          if(biggest2857 == 1){
            active[1]=1;

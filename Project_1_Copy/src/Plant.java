...
>>>>>>> Stashed changes
  ...
  public void thread2447(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest2454 = 0;
        if(ends[8]>=biggest2454){
          biggest2454=ends[8];
        }
        if(ends[9]>=biggest2454){
          biggest2454=ends[9];
        }
        if(ends[10]>=biggest2454){
          biggest2454=ends[10];
        }
        if(ends[11]>=biggest2454){
          biggest2454=ends[11];
        }
        if(ends[12]>=biggest2454){
          biggest2454=ends[12];
        }
        if(ends[13]>=biggest2454){
          biggest2454=ends[13];
        }
        if(biggest2454 == 1){
          active[7]=1;
  ...
  public void thread2433(int [] tdone, int [] ends){
    ...
    int biggest2440 = 0;
    if(ends[8]>=biggest2440){
      biggest2440=ends[8];
    }
    if(ends[9]>=biggest2440){
      biggest2440=ends[9];
    }
    if(ends[10]>=biggest2440){
      biggest2440=ends[10];
    }
    if(ends[11]>=biggest2440){
      biggest2440=ends[11];
    }
    if(ends[12]>=biggest2440){
      biggest2440=ends[12];
    }
    if(ends[13]>=biggest2440){
      biggest2440=ends[13];
    }
    if(biggest2440 == 1){
      active[7]=1;
...
>>>>>>> Stashed changes
      switch(S2348){
        ...
        case 1 : 
          ...
          int biggest2441 = 0;
          if(ends[2]>=biggest2441){
            biggest2441=ends[2];
          }
          if(ends[3]>=biggest2441){
            biggest2441=ends[3];
          }
          if(ends[4]>=biggest2441){
            biggest2441=ends[4];
          }
          if(ends[5]>=biggest2441){
            biggest2441=ends[5];
          }
          if(ends[6]>=biggest2441){
            biggest2441=ends[6];
          }
          if(ends[7]>=biggest2441){
            biggest2441=ends[7];
          }
          if(biggest2441 == 1){
            active[1]=1;

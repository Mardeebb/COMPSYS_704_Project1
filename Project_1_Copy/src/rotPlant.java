...
public class rotPlant extends ClockDomain{
  ...
  public void thread8714(int [] tdone, int [] ends){
        switch(S8236){
      case 0 : 
        active[15]=0;
        ends[15]=0;
  ...
  public void thread8713(int [] tdone, int [] ends){
        switch(S8231){
      case 0 : 
        active[14]=0;
        ends[14]=0;
  ...
  public void thread8711(int [] tdone, int [] ends){
        S8236=1;
    if((Integer)(posOne_13.getpreval() == null ? 0 : ((Integer)posOne_13.getpreval()).intValue()) == 5) {//sysj\plant.sysj line: 253, column: 29
    }
    if((Integer)(posFive_13.getpreval() == null ? 0 : ((Integer)posFive_13.getpreval()).intValue()) != 0) {//sysj\plant.sysj line: 256, column: 30
  ...
  public void thread8710(int [] tdone, int [] ends){
        S8231=1;
    ...
    RUN: while(true){
      switch(S8238){
        ...
        case 1 : 
          ...
          thread8710(tdone,ends);
          thread8711(tdone,ends);
          int biggest8712 = 0;
          if(ends[14]>=biggest8712){
            biggest8712=ends[14];
          }
          if(ends[15]>=biggest8712){
            biggest8712=ends[15];
          }
          if(biggest8712 == 1){
            active[13]=1;
        ...
        case 2 : 
          ...
          posFive_13.setClear();//sysj\plant.sysj line: 217, column: 2
          turn_13.setClear();//sysj\plant.sysj line: 217, column: 2
          thread8713(tdone,ends);
          thread8714(tdone,ends);
          int biggest8715 = 0;
          if(ends[14]>=biggest8715){
            biggest8715=ends[14];
          }
          if(ends[15]>=biggest8715){
            biggest8715=ends[15];
          }
          if(biggest8715 == 1){
            active[13]=1;

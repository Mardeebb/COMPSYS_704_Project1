...
public class rotPlant extends ClockDomain{
  ...
  public void thread1380(int [] tdone, int [] ends){
        active[3]=0;
    ends[3]=0;
    tdone[3]=1;
  }
  ...
  public void thread1377(int [] tdone, int [] ends){
        active[4]=0;
    ends[4]=0;
    tdone[4]=1;
  }
    ...
    RUN: while(true){
      switch(S1373){
        ...
        case 1 : 
          ...
          thread1377(tdone,ends);
          int biggest1378 = 0;
          if(ends[2]>=biggest1378){
            biggest1378=ends[2];
          }
          if(ends[3]>=biggest1378){
            biggest1378=ends[3];
          }
          if(ends[4]>=biggest1378){
            biggest1378=ends[4];
          }
          //FINXME code
          if(biggest1378 == 0){
        ...
        case 2 : 
          ...
          thread1380(tdone,ends);
          thread1381(tdone,ends);
          int biggest1382 = 0;
          if(ends[2]>=biggest1382){
            biggest1382=ends[2];
          }
          if(ends[3]>=biggest1382){
            biggest1382=ends[3];
          }
          if(ends[4]>=biggest1382){
            biggest1382=ends[4];
          }
          //FINXME code
          if(biggest1382 == 0){

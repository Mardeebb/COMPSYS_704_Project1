...
public class rotPlant extends ClockDomain{
  ...
  private int[] packedArray_thread_3;//sysj\plant.sysj line: 128, column: 3
  private int pos_thread_3;//sysj\plant.sysj line: 129, column: 3
  private int pos1_thread_3;//sysj\plant.sysj line: 141, column: 5
  private int pos5_thread_3;//sysj\plant.sysj line: 142, column: 5
  private int[] newPackedArray_thread_3;//sysj\plant.sysj line: 146, column: 5
  private int S1006 = 1;
  private int S999 = 1;
  private int S936 = 1;
  private int S1004 = 1;
  ...
  public void thread1692(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        if((Integer)(posFive_2.getpreval() == null ? 0 : ((Integer)posFive_2.getpreval()).intValue()) != 0) {//sysj\plant.sysj line: 165, column: 30
        }
        active[4]=1;
        ends[4]=1;
        tdone[4]=1;
  ...
  public void thread1691(int [] tdone, int [] ends){
      ...
      case 1 : 
        if(!rotaryTableTrigger.getprestatus()){//sysj\plant.sysj line: 138, column: 10
          S936=0;
          active[3]=1;
          ends[3]=1;
          tdone[3]=1;
          ...
          switch(S936){
            case 0 : 
              if(rotaryTableTrigger.getprestatus()){//sysj\plant.sysj line: 139, column: 11
                S936=1;
                active[3]=1;
                ends[3]=1;
                tdone[3]=1;
            ...
            case 1 : 
              if(enable.getprestatus()){//sysj\plant.sysj line: 140, column: 11
                pos1_thread_3 = packedArray_thread_3[0];//sysj\plant.sysj line: 141, column: 5
                pos5_thread_3 = packedArray_thread_3[4];//sysj\plant.sysj line: 142, column: 5
                rotTurn.setPresent();//sysj\plant.sysj line: 143, column: 5
                currsigs.addElement(rotTurn);
                rotTurn.setValue(packedArray_thread_3);//sysj\plant.sysj line: 143, column: 5
                System.out.println("Emitted rotTurn");
                posOne_2.setPresent();//sysj\plant.sysj line: 144, column: 5
                currsigs.addElement(posOne_2);
                posOne_2.setValue(pos1_thread_3);//sysj\plant.sysj line: 144, column: 5
                System.out.println("Emitted posOne_2");
                posFive_2.setPresent();//sysj\plant.sysj line: 145, column: 5
                currsigs.addElement(posFive_2);
                posFive_2.setValue(pos5_thread_3);//sysj\plant.sysj line: 145, column: 5
                System.out.println("Emitted posFive_2");
                newPackedArray_thread_3 = new int[6];//sysj\plant.sysj line: 146, column: 5
                newPackedArray_thread_3[0] = packedArray_thread_3[5];//sysj\plant.sysj line: 147, column: 5
                for(int i_thread_3 = 1; i_thread_3 < 6; i_thread_3 = i_thread_3 + 1) {//sysj\plant.sysj line: 149, column: 31
                  newPackedArray_thread_3[i_thread_3] = packedArray_thread_3[i_thread_3 - 1];//sysj\plant.sysj line: 150, column: 6
                }
                packedArray_thread_3 = newPackedArray_thread_3;//sysj\plant.sysj line: 152, column: 5
                S936=2;
                tableAlignedWithSensorC.setPresent();//sysj\plant.sysj line: 153, column: 5
  ...
  public void thread1688(int [] tdone, int [] ends){
    ...
    for(int i_thread_3 = 0; i_thread_3 < 6; i_thread_3 = i_thread_3 + 1) {//sysj\plant.sysj line: 130, column: 29
      packedArray_thread_3[i_thread_3] = 0;//sysj\plant.sysj line: 131, column: 7
    }
    packedArray_thread_3[0] = 5;//sysj\plant.sysj line: 134, column: 6
    packedArray_thread_3[3] = 1;//sysj\plant.sysj line: 135, column: 6
    S936=0;
    active[3]=1;
    ends[3]=1;
    tdone[3]=1;

...
public class bController extends ClockDomain{
  ...
  public void thread10180(int [] tdone, int [] ends){
        switch(S9808){
      case 0 : 
        active[3]=0;
        ends[3]=0;
  ...
  public void thread10179(int [] tdone, int [] ends){
        switch(S9626){
      case 0 : 
        active[2]=0;
        ends[2]=0;
  ...
  public void thread10177(int [] tdone, int [] ends){
        S9808=1;
    S9630=0;
    active[3]=1;
    ends[3]=1;
  ...
  public void thread10176(int [] tdone, int [] ends){
        S9626=1;
    S9448=0;
    active[2]=1;
    ends[2]=1;
    ...
    RUN: while(true){
      switch(S10174){
        ...
        case 1 : 
          ...
          thread10176(tdone,ends);
          thread10177(tdone,ends);
          int biggest10178 = 0;
          if(ends[2]>=biggest10178){
            biggest10178=ends[2];
          }
          if(ends[3]>=biggest10178){
            biggest10178=ends[3];
          }
          if(biggest10178 == 1){
            active[1]=1;
        ...
        case 2 : 
          thread10179(tdone,ends);
          thread10180(tdone,ends);
          int biggest10181 = 0;
          if(ends[2]>=biggest10181){
            biggest10181=ends[2];
          }
          if(ends[3]>=biggest10181){
            biggest10181=ends[3];
          }
          if(biggest10181 == 1){
            active[1]=1;

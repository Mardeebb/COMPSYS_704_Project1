...
public class bController extends ClockDomain{
  ...
  public void thread7980(int [] tdone, int [] ends){
        S7611=1;
    S7433=0;
    active[3]=1;
    ends[3]=1;
  ...
  public void thread7979(int [] tdone, int [] ends){
        S7429=1;
    S7251=0;
    active[2]=1;
    ends[2]=1;
    ...
    RUN: while(true){
      switch(S7977){
        ...
        case 1 : 
          ...
          thread7979(tdone,ends);
          thread7980(tdone,ends);
          int biggest7981 = 0;
          if(ends[2]>=biggest7981){
            biggest7981=ends[2];
          }
          if(ends[3]>=biggest7981){
            biggest7981=ends[3];
          }
          if(biggest7981 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest7984 = 0;
          if(ends[2]>=biggest7984){
            biggest7984=ends[2];
          }
          if(ends[3]>=biggest7984){
            biggest7984=ends[3];
          }
          if(biggest7984 == 1){
            active[1]=1;

          ...
          switch(S2676){
            ...
            case 1 : 
              if(bottleAtPos2.getprestatus()){//sysj\fillerController.sysj line: 14, column: 12
                ...
                int biggest3062 = 0;
                if(ends[2]>=biggest3062){
                  biggest3062=ends[2];
                }
                if(ends[3]>=biggest3062){
                  biggest3062=ends[3];
                }
                if(biggest3062 == 1){
                  active[1]=1;
            ...
            case 2 : 
              if(dosUnitFilled.getprestatus()){//sysj\fillerController.sysj line: 17, column: 12
                ...
                int biggest3065 = 0;
                if(ends[2]>=biggest3065){
                  biggest3065=ends[2];
                }
                if(ends[3]>=biggest3065){
                  biggest3065=ends[3];
                }
                if(biggest3065 == 1){
                  active[1]=1;
            ...
            case 3 : 
              ...
              int biggest3068 = 0;
              if(ends[4]>=biggest3068){
                biggest3068=ends[4];
              }
              if(ends[5]>=biggest3068){
                biggest3068=ends[5];
              }
              if(biggest3068 == 1){
                active[1]=1;
            ...
            case 4 : 
              if(dosUnitEvac.getprestatus()){//sysj\fillerController.sysj line: 29, column: 12
                ...
                int biggest3071 = 0;
                if(ends[4]>=biggest3071){
                  biggest3071=ends[4];
                }
                if(ends[5]>=biggest3071){
                  biggest3071=ends[5];
                }
                if(biggest3071 == 1){
                  active[1]=1;

...
public class CapperPlant extends ClockDomain{
  ...
  public void thread2456(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest2461 = 0;
        if(ends[6]>=biggest2461){
          biggest2461=ends[6];
        }
        if(ends[7]>=biggest2461){
          biggest2461=ends[7];
        }
        if(ends[8]>=biggest2461){
          biggest2461=ends[8];
        }
        if(ends[9]>=biggest2461){
          biggest2461=ends[9];
        }
        if(biggest2461 == 1){
          active[5]=1;
  ...
  public void thread2446(int [] tdone, int [] ends){
    ...
    int biggest2451 = 0;
    if(ends[6]>=biggest2451){
      biggest2451=ends[6];
    }
    if(ends[7]>=biggest2451){
      biggest2451=ends[7];
    }
    if(ends[8]>=biggest2451){
      biggest2451=ends[8];
    }
    if(ends[9]>=biggest2451){
      biggest2451=ends[9];
    }
    if(biggest2451 == 1){
      active[5]=1;
    ...
    RUN: while(true){
      switch(S2441){
        ...
        case 1 : 
          ...
          int biggest2452 = 0;
          if(ends[2]>=biggest2452){
            biggest2452=ends[2];
          }
          if(ends[3]>=biggest2452){
            biggest2452=ends[3];
          }
          if(ends[4]>=biggest2452){
            biggest2452=ends[4];
          }
          if(ends[5]>=biggest2452){
            biggest2452=ends[5];
          }
          if(biggest2452 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest2462 = 0;
          if(ends[2]>=biggest2462){
            biggest2462=ends[2];
          }
          if(ends[3]>=biggest2462){
            biggest2462=ends[3];
          }
          if(ends[4]>=biggest2462){
            biggest2462=ends[4];
          }
          if(ends[5]>=biggest2462){
            biggest2462=ends[5];
          }
          if(biggest2462 == 1){
            active[1]=1;

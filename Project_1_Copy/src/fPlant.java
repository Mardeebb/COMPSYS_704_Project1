...
public class fPlant extends ClockDomain{
  ...
  public void thread3188(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest3191 = 0;
        if(ends[5]>=biggest3191){
          biggest3191=ends[5];
        }
        if(ends[6]>=biggest3191){
          biggest3191=ends[6];
        }
        if(biggest3191 == 1){
          active[4]=1;
  ...
  public void thread3181(int [] tdone, int [] ends){
    ...
    int biggest3184 = 0;
    if(ends[5]>=biggest3184){
      biggest3184=ends[5];
    }
    if(ends[6]>=biggest3184){
      biggest3184=ends[6];
    }
    if(biggest3184 == 1){
      active[4]=1;
    ...
    RUN: while(true){
      switch(S3177){
        ...
        case 1 : 
          ...
          int biggest3185 = 0;
          if(ends[2]>=biggest3185){
            biggest3185=ends[2];
          }
          if(ends[3]>=biggest3185){
            biggest3185=ends[3];
          }
          if(ends[4]>=biggest3185){
            biggest3185=ends[4];
          }
          if(biggest3185 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest3192 = 0;
          if(ends[2]>=biggest3192){
            biggest3192=ends[2];
          }
          if(ends[3]>=biggest3192){
            biggest3192=ends[3];
          }
          if(ends[4]>=biggest3192){
            biggest3192=ends[4];
          }
          if(biggest3192 == 1){
            active[1]=1;

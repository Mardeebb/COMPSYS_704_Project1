...
public class fPlant extends ClockDomain{
  ...
  public void thread3187(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest3190 = 0;
        if(ends[5]>=biggest3190){
          biggest3190=ends[5];
        }
        if(ends[6]>=biggest3190){
          biggest3190=ends[6];
        }
        if(biggest3190 == 1){
          active[4]=1;
  ...
  public void thread3180(int [] tdone, int [] ends){
    ...
    int biggest3183 = 0;
    if(ends[5]>=biggest3183){
      biggest3183=ends[5];
    }
    if(ends[6]>=biggest3183){
      biggest3183=ends[6];
    }
    if(biggest3183 == 1){
      active[4]=1;
    ...
    RUN: while(true){
      switch(S3176){
        ...
        case 2 : 
          ...
          int biggest3191 = 0;
          if(ends[2]>=biggest3191){
            biggest3191=ends[2];
          }
          if(ends[3]>=biggest3191){
            biggest3191=ends[3];
          }
          if(ends[4]>=biggest3191){
            biggest3191=ends[4];
          }
          if(biggest3191 == 1){
            active[1]=1;

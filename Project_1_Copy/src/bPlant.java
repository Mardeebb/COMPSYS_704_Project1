...
public class bPlant extends ClockDomain{
  ...
  public void thread4840(int [] tdone, int [] ends){
        switch(S4585){
      case 0 : 
        active[7]=0;
        ends[7]=0;
  ...
  public void thread4837(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        thread4840(tdone,ends);
        thread4841(tdone,ends);
        int biggest4842 = 0;
        if(ends[5]>=biggest4842){
          biggest4842=ends[5];
        }
        if(ends[6]>=biggest4842){
          biggest4842=ends[6];
        }
        if(ends[7]>=biggest4842){
          biggest4842=ends[7];
        }
        if(ends[8]>=biggest4842){
          biggest4842=ends[8];
        }
        if(biggest4842 == 1){
          active[4]=1;
  ...
  public void thread4835(int [] tdone, int [] ends){
        switch(S4460){
      case 0 : 
        active[2]=0;
        ends[2]=0;
  ...
  public void thread4830(int [] tdone, int [] ends){
        S4568=1;
    S4556=0;
    if(CMD_L2.getprestatus()){//sysj\robotPlant.sysj line: 64, column: 17
      s_thread_6 = (String)(CMD_L2.getpreval() == null ? null : ((String)CMD_L2.getpreval()));//sysj\robotPlant.sysj line: 65, column: 10
  ...
  public void thread4828(int [] tdone, int [] ends){
    ...
    thread4830(tdone,ends);
    thread4831(tdone,ends);
    thread4832(tdone,ends);
    int biggest4833 = 0;
    if(ends[5]>=biggest4833){
      biggest4833=ends[5];
    }
    if(ends[6]>=biggest4833){
      biggest4833=ends[6];
    }
    if(ends[7]>=biggest4833){
      biggest4833=ends[7];
    }
    if(ends[8]>=biggest4833){
      biggest4833=ends[8];
    }
    if(biggest4833 == 1){
      active[4]=1;
  ...
  public void thread4827(int [] tdone, int [] ends){
        S4534=1;
    S4464=0;
    active[3]=1;
    ends[3]=1;
    ...
    RUN: while(true){
      switch(S4824){
        ...
        case 1 : 
          ...
          thread4827(tdone,ends);
          thread4828(tdone,ends);
          int biggest4834 = 0;
          if(ends[2]>=biggest4834){
            biggest4834=ends[2];
          }
          if(ends[3]>=biggest4834){
            biggest4834=ends[3];
          }
          if(ends[4]>=biggest4834){
            biggest4834=ends[4];
          }
          if(biggest4834 == 1){
            active[1]=1;
        ...
        case 2 : 
          thread4835(tdone,ends);
          thread4836(tdone,ends);
          thread4837(tdone,ends);
          int biggest4843 = 0;
          if(ends[2]>=biggest4843){
            biggest4843=ends[2];
          }
          if(ends[3]>=biggest4843){
            biggest4843=ends[3];
          }
          if(ends[4]>=biggest4843){
            biggest4843=ends[4];
          }
          if(biggest4843 == 1){
            active[1]=1;
